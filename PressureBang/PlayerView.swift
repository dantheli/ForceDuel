...
class PlayerView: UIView {
    ...
    override func touchesMoved(touches: Set<UITouch>, withEvent event: UIEvent?) {
        for touch in touches {
            ...
            NSNotificationCenter.defaultCenter().postNotificationName("updateForce", object: nil, userInfo: ["player" : playerNumber, "force" : forceInt])
    ...
    override func touchesEnded(touches: Set<UITouch>, withEvent event: UIEvent?) {
        NSNotificationCenter.defaultCenter().postNotificationName("updateForce", object: nil, userInfo: ["player" : playerNumber, "force" : 0])
        NSNotificationCenter.defaultCenter().postNotificationName("playerExited", object: nil, userInfo: ["player" : playerNumber])
    }
